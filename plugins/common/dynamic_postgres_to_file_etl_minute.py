...
def create_postgres_to_file_meta_tasks(
    dag_id: str,
    meta_postgres_conn_id: str = DEFAULT_META_POSTGRES_CONN_ID,
):
    """
    PostgreSQL -> File Meta 기반 ETL 공통 Task 생성 함수.

    사용 예:
        table_configs, run_etl_tasks = create_postgres_to_file_meta_tasks(
            dag_id=DAG_ID
        )
    """
    ...
    def get_table_configs():
        ...
        print(f"Loaded PostgreSQL to File ETL configs. dag_id={dag_id}")
