...
# ****** airflow 전용 ******
def create_file_to_redshift_task(
    dag_id: str,
    task_name: str,
    ...
    if airflow_task is None:
        raise RuntimeError(
            "create_file_to_redshift_task() requires Airflow. "
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run static file to Redshift ETL without Airflow."
    )
