...
def create_file_to_postgres_meta_tasks(
    dag_id: str,
    meta_postgres_conn_id: str = DEFAULT_META_POSTGRES_CONN_ID,
):
    """
    File -> PostgreSQL Meta 기반 ETL 공통 Task 생성 함수.

    사용 예:
        table_configs, run_etl_tasks = create_file_to_postgres_meta_tasks(
            dag_id=DAG_ID
        )
    """
    ...
    def get_table_configs():
        ...
        print(f"Loaded File to PostgreSQL ETL configs. dag_id={dag_id}")
