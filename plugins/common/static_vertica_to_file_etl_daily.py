...
# ****** airflow 전용 ******
def create_vertica_to_file_task(
    dag_id: str,
    task_name: str,
    ...
    if airflow_task is None:
        raise RuntimeError(
            "create_vertica_to_file_task() requires Airflow. "
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run static Vertica to file ETL without Airflow."
    )
